            ...
            <div class="container  " >
                ...
                <div class="row"  >
                    <div class="col-sm-12 col-lg-12 mt-4"   >
                        ...
                        <form class=" mb-3"method="POST" action="{{route('capturista.publicaciones.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="modal fade" id="editModal{{$publicacion->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form class=" mb-3 "method="POST" action="{{route('capturista.publicaciones.update',$publicacion->id)}}" enctype="multipart/form-data">
                                                    @csrf @method('PUT')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="border: none">
                <form id="formDelete"  data-action="{{route('capturista.publicaciones.delete',1)}}" method="POST">
                @csrf 
